...
- [x] **3.6** إضافة Pagination الاستاتيكي لصفحتي Design و Blog — ✅ 2026-05-25
  - إنشاء مكوّن `Pagination.tsx` مشترك بألوان المشروع المتوافقة.
  - إعداد دوال جلب الصفحات وتحديد عدد العناصر في `strapi.ts`.
  - تحديث صفحات `/design` و `/blog` وإنشاء المسارات الاستاتيكية الديناميكية `/page/[pageNum]`.
  - إعداد `generateStaticParams` لحل مشكلة عدم وجود صفحات إضافية عند قلة البيانات في البيئات التطويرية.
