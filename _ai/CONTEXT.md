...
## المشروع
موقع شخصي — Next.js 15 + Strapi 5 + next-intl (ar/en) + Tailwind CSS v4 + shadcn/ui
...
frontend/components/layout/ → Header Footer Navbar LanguageSwitcher
...
## التعليمات
1. اقرأ CONTEXT.md + TODO.md قبل أي عمل
2. نفّذ المهمة الأولى في TODO فقط
3. بعد الانتهاء: حدّث TODO.md + أنشئ/حدّث ملف docs المناسب
4. لا تقرأ ملفات docs إلا للصفحة التي تعمل عليها الآن
