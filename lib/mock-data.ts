...
export const mockAbout: About = {
  ...
  bio_en:
    "Electronics engineer passionate about circuit design and technical writing...",
  ...
  social_links: [
    {
      platform: "linkedin",
      url: "https://linkedin.com/in/manaaelectronics",
      label: "LinkedIn",
    },
  ],
...
export const mockDesigns: Design[] = [
  {
    id: 1,
    slug: "power-supply-5v",
    title_ar: "مصدر طاقة 5 فولت",
    title_en: "5V Power Supply",
    description_ar: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "دائرة مصدر طاقة منظّمة بجهد 5 فولت..." },
        ],
      },
    ],
    description_en: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "Regulated 5V power supply circuit..." },
        ],
      },
    ],
  ...
  },
  {
    id: 2,
    slug: "arduino-shield",
    title_ar: "درع أردوينو مخصص",
    title_en: "Custom Arduino Shield",
    description_ar: [
      {
        type: "paragraph",
        children: [
          {
            type: "text",
            text: "درع لوحة أردوينو لقياس درجة الحرارة والرطوبة...",
          },
        ],
      },
    ],
    description_en: [
      {
        ...
        children: [
          {
            type: "text",
            text: "Arduino shield for temperature and humidity sensing...",
          },
        ],
      },
    ],
  ...
  {
    id: 3,
    slug: "555-timer-circuit",
    title_ar: "دائرة مؤقت 555",
    title_en: "555 Timer Circuit",
    description_ar: [
      {
        type: "paragraph",
        children: [
          {
            type: "text",
            text: "دائرة كلاسيكية باستخدام IC 555 لتوليد نبضات...",
          },
        ],
      },
    ],
    description_en: [
      {
        ...
        children: [
          {
            type: "text",
            text: "Classic 555 timer IC circuit for pulse generation...",
          },
        ],
      },
    ],
    category: {
      id: 3,
      slug: "basic",
      name_ar: "دوائر أساسية",
      name_en: "Basic Circuits",
    },
    date: "2023-11-10",
...
export const mockPosts: Post[] = [
  {
    id: 1,
    slug: "why-i-love-electronics",
    title_ar: "لماذا أعشق الإلكترونيات",
    title_en: "Why I Love Electronics",
    content_ar: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "منذ صغري وأنا مفتون بكيف تعمل الأجهزة..." },
        ],
      },
    ],
    content_en: [
      {
        ...
        children: [
          {
            type: "text",
            text: "Since childhood, I've been fascinated by how devices work...",
          },
        ],
      },
    ],
    date: "2024-04-10",
    tags: "إلكترونيات, شخصي",
  },
  {
    id: 2,
    slug: "altium-vs-kicad",
    title_ar: "Altium مقابل KiCad: تجربتي",
    title_en: "Altium vs KiCad: My Experience",
    content_ar: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "بعد سنوات من استخدام كلا البرنامجين..." },
        ],
      },
    ],
    content_en: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "After years of using both tools..." },
        ],
      },
    ],
    date: "2024-02-05",
  ...
  },
  {
    id: 3,
    slug: "my-first-pcb",
    title_ar: "أول لوحة PCB أصممها",
    title_en: "My First PCB Design",
    content_ar: [
      {
        type: "paragraph",
        children: [
          { type: "text", text: "أتذكر حين رأيت أول لوحة طبعية صممتها..." },
        ],
      },
    ],
    content_en: [
      {
        ...
        children: [
          {
            type: "text",
            text: "I remember seeing my first printed circuit board design...",
          },
        ],
      },
    ],
