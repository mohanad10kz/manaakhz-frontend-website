...
export const mockDesigns: Design[] = [
  {
    ...
    description_ar: [{ type: "paragraph", children: [{ type: "text", text: "دائرة مصدر طاقة منظّمة بجهد 5 فولت..." }] }],
    description_en: [{ type: "paragraph", children: [{ type: "text", text: "Regulated 5V power supply circuit..." }] }],
  ...
  },
  {
    ...
    description_ar: [{ type: "paragraph", children: [{ type: "text", text: "درع لوحة أردوينو لقياس درجة الحرارة والرطوبة..." }] }],
    description_en: [{ type: "paragraph", children: [{ type: "text", text: "Arduino shield for temperature and humidity sensing..." }] }],
  ...
  },
  {
    ...
    description_ar: [{ type: "paragraph", children: [{ type: "text", text: "دائرة كلاسيكية باستخدام IC 555 لتوليد نبضات..." }] }],
    description_en: [{ type: "paragraph", children: [{ type: "text", text: "Classic 555 timer IC circuit for pulse generation..." }] }],
