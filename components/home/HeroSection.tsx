    ...
    <section className="relative min-h-[calc(100vh-5rem)] flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center opacity-5 pointer-events-none">
        <svg width="600" height="600" viewBox="0 0 100 100" className="text-primary">
          ...
          <path d="M 22 22 L 78 78 M 22 78 L 78 22" stroke="currentColor" strokeWidth="0.5" />
        </svg>
      </div>
      ...
      <div className="container max-w-[1100px] mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <Button asChild size="lg" className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 font-bold h-12 px-8">
            <Link href="/design">
              {t("cta_primary")}
            </Link>
          </Button>
          
          <Button asChild variant="outline" size="lg" className="w-full sm:w-auto border-secondary text-secondary hover:bg-secondary/10 hover:text-secondary font-bold h-12 px-8">
            <Link href="/blog">
              {t("cta_secondary")}
            </Link>
          </Button>
