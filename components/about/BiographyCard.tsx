...
export function BiographyCard({ locale }: { locale: string }) {
  ...
  return (
    <div className="container max-w-[1100px] mx-auto px-6 py-20 bg-background">
      <div className="flex flex-col md:flex-row gap-16 md:gap-24">
        
        {/* Left Column (40%) */}
        <div className="md:w-2/5 flex flex-col items-center text-center">
          <div className="w-[200px] h-[200px] rounded-full border-[3px] border-primary p-1 mb-6">
          ...
          <h1 className="text-3xl font-bold font-sans text-foreground mb-2">{name}</h1>
          <p className="text-lg text-secondary font-medium mb-3">مهندس إلكترونيات ومصمم دوائر</p>
        ...
        <div className="md:w-3/5 flex flex-col">
          <div className="mb-6">
            <h2 className="text-2xl font-bold font-sans text-foreground mb-2">نبذة عني</h2>
          ...
          <div>
            <h3 className="uppercase text-sm font-bold text-primary mb-4 tracking-wider">المهارات</h3>
