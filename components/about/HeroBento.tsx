...
export function HeroBento({ about, locale }: HeroBentoProps) {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
      ...
      <div className="col-span-1 lg:col-span-5 flex flex-col items-center text-center p-8 bg-gradient-to-b from-surface to-surface-container rounded-xl border border-outline-variant relative overflow-hidden">
        {/* Abstract Background Shape */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

        <div className="w-48 h-48 rounded-full border-4 border-primary p-1 bg-surface overflow-hidden mb-6 relative z-10 shadow-lg">
          <ExportedImage
            src={
              about.photo ||
        ...
        <div className="flex items-center gap-2 text-on-surface-variant text-sm mb-6 bg-surface-variant/50 px-4 py-2 rounded-full relative z-10">
          <MapPin className="w-4 h-4 text-primary" />
          <span>{nationality}</span>
        </div>

        <p className="text-on-surface leading-relaxed text-sm lg:text-base max-w-md relative z-10 mb-8 whitespace-pre-wrap">
          {bio}
        </p>
      ...
      <div className="col-span-1 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-gutter content-start">
        {/* Info Card 1 */}
        <div className="bg-surface border border-outline-variant rounded-xl p-6 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-on-surface font-arabic-headline font-bold text-lg">
        ...
        <div className="bg-surface border border-outline-variant rounded-xl p-6 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-on-surface font-arabic-headline font-bold text-lg leading-snug">
            {education}
          </p>
        </div>
        ...
        <div className="bg-surface border border-outline-variant rounded-xl p-6 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="text-on-surface font-arabic-headline font-bold text-lg leading-snug">
